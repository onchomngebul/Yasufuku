       ...
       <div class="row">
              <div class="col-md-12">
                     <div class="panel panel-default">
                            <div class="panel-heading">Create New prod_plan</div>
                            <div class="panel-body">
                                   ...
                                   {!! Form::open(['url' => '/prod_plans', 'class' => 'form-horizontal', 'files' => true]) !!}

                                   <div class="form-group {{ $errors->has('pp_date') ? 'has-error' : ''}}">
                                          {{-- {!! Form::label('pp_date', 'Pp Date', ['class' => 'col-md-4 control-label']) !!} --}}
                                          <label class="control-label col-md-4" name="pp_date" >Date</label>
                                          <div class="col-md-6">
                                                 {{-- {!! Form::date('pp_date', null, ['class' => 'form-control']) !!} --}}
                                                 <input type="text" class="form-control iniTanggal" id="pp_date" name="pp_date">
